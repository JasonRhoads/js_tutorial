...
function dakotaFinder(dakota) {
  return dakota.filter(dak => dak.includes("Dakota"));
}

console.log(dakotaFinder(states));

// reduce: Imperative version
